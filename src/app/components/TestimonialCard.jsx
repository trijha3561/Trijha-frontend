...
const TestimonialCard = ({ testimonial, position }) => {  
  ...
  if (position === 'left') {
    background = 'bg-gradient-to-l from-white to-transparent scale-95';
  } else if (position === 'middle') {
    background = 'bg-white scale-105';
  } else {
    background = 'bg-gradient-to-r from-white to-transparent scale-95';
  }
